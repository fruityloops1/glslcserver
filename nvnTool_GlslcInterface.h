...
typedef enum SpillControlEnum_enum { DEFAULT_SPILL,
    NO_SPILL } SpillControlEnum;

typedef enum GLSLCoptLevel_enum { GLSLC_OPTLEVEL_DEFAULT,
    GLSLC_OPTLEVEL_NONE } GLSLCoptLevelEnum;
